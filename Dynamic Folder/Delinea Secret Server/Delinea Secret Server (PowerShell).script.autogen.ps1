...
#
#    The source code below was extracted from `./Delinea Secret Server (PowerShell).rdfe`
#
#    Do not edit this file; instead update the scripts embedded in `./Delinea Secret Server (PowerShell).rdfe`
# </auto-generated>
# ----------------------
