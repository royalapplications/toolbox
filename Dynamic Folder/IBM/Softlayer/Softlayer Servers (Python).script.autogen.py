...
#
#    The source code below was extracted from `./Softlayer Servers (Python).rdfe`
#
#    Do not edit this file; instead update the scripts embedded in `./Softlayer Servers (Python).rdfe`
# </auto-generated>
# ----------------------
