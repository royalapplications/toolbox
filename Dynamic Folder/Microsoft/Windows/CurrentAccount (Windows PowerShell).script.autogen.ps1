...
#
#    The source code below was extracted from `./CurrentAccount (Windows PowerShell).rdfx`
#
#    Do not edit this file; instead update the scripts embedded in `./CurrentAccount (Windows PowerShell).rdfx`
# </auto-generated>
# ----------------------
