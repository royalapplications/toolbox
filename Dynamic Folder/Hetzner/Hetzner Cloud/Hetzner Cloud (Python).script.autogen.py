...
#
#    The source code below was extracted from `./Hetzner Cloud (Python).rdfe`
#
#    Do not edit this file; instead update the scripts embedded in `./Hetzner Cloud (Python).rdfe`
# </auto-generated>
# ----------------------
